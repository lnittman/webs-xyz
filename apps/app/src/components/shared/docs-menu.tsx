    ...
    return (
        <DropdownMenu open={menuOpen} onOpenChange={setMenuOpen}>
            <DropdownMenuTrigger asChild>
                <button
                    className={cn(
                        "h-8 w-8 text-muted-foreground flex items-center justify-center rounded-full border border-border transition-all duration-200",
                        ...
                        menuOpen ? "bg-accent text-foreground border-foreground/20" : "bg-muted"
                    )}
            ...
            <DropdownMenuContent
                ...
                sideOffset={8}
                className={cn(
                    "w-[260px] p-0 bg-popover border-border/50 rounded-lg font-mono overflow-hidden"
                )}
            >
                <motion.div
                            ...
                            <React.Fragment key={link.id}>
                                ...
                                >
                                    <div className="flex items-center justify-between w-full">
                                        ...
                                        <ArrowUpRight className="w-4 h-4 ml-2 flex-shrink-0" weight="duotone" />
                                    </div>
                                </DropdownMenuItem>
                            </React.Fragment>
                        ))}
