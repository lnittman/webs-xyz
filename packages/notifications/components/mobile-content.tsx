...
export function MobileNotificationsContent({ onNavigate }: MobileNotificationsContentProps) {
        ...
        return (
            <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
                <div className="w-20 h-20 rounded-2xl bg-muted/30 flex items-center justify-center mb-6">
                    <Lightning className="w-10 h-10 text-muted-foreground/50" weight="duotone" />
                </div>
                <h3 className="text-lg font-medium text-foreground mb-2">Notifications not configured</h3>
                <p className="text-sm text-muted-foreground text-center max-w-xs">
                    Notification system is not set up for this environment.
                </p>
            </div>
        );
    }
